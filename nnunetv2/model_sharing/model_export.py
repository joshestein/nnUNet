        ...
        for c in configurations:
            ...
            if isdir(source_folder):
                if export_crossval_predictions:
                    ...
                    source_files = [
                        join(trainer_output_dir, f"crossval_results_folds_{folds_tuple_to_string(folds)}", i)
...
if __name__ == "__main__":
    export_pretrained_model(
        2, "/home/fabian/temp/dataset2.zip", strict=False, export_crossval_predictions=True, folds=(0,)
    )
